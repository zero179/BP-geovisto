...
import { LayerToolState, LayerToolDefaults, MapFormInputFactory, AbstractMapFormInput, LabeledAutocompleteFormInput, MapLayerToolForm, AbstractLayerTool } from 'geovisto';
...
const iconStarter = {
    shadowUrl: undefined,
    iconAnchor: new L__default.Point(12, 12),
    iconSize: new L__default.Point(24, 24),
};
const ICON_SRCS = [
...
const convertCoords = (feature) => {
    ...
    if (feature.geometry.type === "Point") {
        return L__default.GeoJSON.coordsToLatLng(coords);
    }
    else if (feature.geometry.type === "LineString") {
        return L__default.GeoJSON.coordsToLatLngs([coords], 1);
    }
    else {
        return L__default.GeoJSON.coordsToLatLngs(coords, depth);
    }
};
/**
...
const morphFeatureToPolygon = (feature, options = {}, simplify = false) => {
    ...
    const latlngs = L__default.GeoJSON.coordsToLatLngs(coords, depth);
    const result = new L__default.polygon(latlngs, Object.assign(Object.assign({}, options), { draggable: true, transform: true }));
...
class PaintTool extends AbstractTool {
    constructor(props) {
        ...
        this.startPaint = () => {
            ...
            if (this.leafletMap)
                this._circle = L__default.circleMarker(this._latlng, {
                    color: DEFAULT_COLOR,
                })
        ...
        this._redrawShapes = () => {
            ...
            const result = new L__default.polygon(latlngs, Object.assign(Object.assign({}, opts), styles));
        ...
        this._fireCreatedShapes = () => {
            ...
            var _a;
            (_a = this === null || this === void 0 ? void 0 : this.leafletMap) === null || _a === void 0 ? void 0 : _a.fire(L__default.Draw.Event.CREATED, {
        ...
        this._circle = null;
        this._mouseDown = false;
        this._latlng = L__default.latLng(0, 0);
    ...
    constructor(props) {
        ...
        this.erase = (event) => {
            if (event.type == "mousedown") {
                L__default.DomEvent.stop(event);
                return;
            }
        };
 ...
 */
L__default.Draw.Slice = L__default.Draw.Polyline.extend({
    statics: {
        TYPE: "knife",
    },
    ...
    initialize: function (map, options) {
        ...
        if (L__default.Browser.touch) {
            this.options.icon = this.options.touchIcon;
        }
        // Need to set this here to ensure the correct message is used.
        this.options.drawError.message = L__default.drawLocal.draw.handlers.polyline.error;
        // Merge default drawError options with custom options
        if (options && options.drawError) {
            options.drawError = L__default.Util.extend({}, this.options.drawError, options.drawError);
        }
        // Save the type so super can fire, need to do this as cannot do this.TYPE :(
        this.type = L__default.Draw.Slice.TYPE;
        L__default.Draw.Feature.prototype.initialize.call(this, map, options);
    },
    _calculateFinishDistance: function (potentialLatLng) {
        let lastPtDistance;
        if (this._markers.length > 0) {
            let finishMarker;
            if (this.type === L__default.Draw.Polyline.TYPE ||
                this.type === L__default.Draw.Slice.TYPE) {
                finishMarker = this._markers[this._markers.length - 1];
            }
            else if (this.type === L__default.Draw.Polygon.TYPE) {
                finishMarker = this._markers[0];
            }
            else {
                return Infinity;
            }
            const lastMarkerPoint = this._map.latLngToContainerPoint(finishMarker.getLatLng()), potentialMarker = new L__default.Marker(potentialLatLng, {
...
class GeometricSliceTool extends AbstractTool {
    constructor(props) {
        ...
        this._dividePoly = () => {
            if (!this.leafletMap)
                return;
            this.activetool = new L__default.Draw.Slice(this.leafletMap, {
                shapeOptions: {
                    color: "#333",
                    weight: 3,
                    draggable: true,
            ...
            if (isFeatPoly) {
                ...
                try {
                    ...
                    coords.forEach((coord) => {
                        latlngs = L__default.GeoJSON.coordsToLatLngs(coord, 1);
                        const result = new L__default.polygon(latlngs, Object.assign(Object.assign({}, selectedLayer.options), normalStyles));
                        result.layerType = "polygon";
...
class FreehandSliceTool extends GeometricSliceTool {
    constructor(props) {
        ...
        this.pather = new L__default.Pather({
            strokeWidth: 3,
            smoothFactor: 5,
 ...
 */
L__default.Draw.ExtendedMarker = L__default.Draw.Marker.extend({
...
class MarkerTool extends AbstractTool {
    constructor(props) {
        ...
        this._markerCreate = (connectClick = false) => {
            ...
            const icon = new L__default.Icon(Object.assign(Object.assign({}, iconStarter), additionalOpts));
            const { guideLayers } = this.sidebar.getState();
            this.activetool = new L__default.Draw.ExtendedMarker(this.leafletMap, {
                icon,
                draggable: true,
                transform: true,
                repeatMode: true,
...
class TopologyTool extends MarkerTool {
    ...
    plotTopology(chosen = null, createdMarker = null) {
        ...
        if (secondMarker) {
            ...
            // * create vertice
            const _latlng = [L__default.latLng(fLat, fLng), L__default.latLng(sLat, sLng)];
            const poly = new L__default.polyline(_latlng, Object.assign({ color: "#563412", weight: 3 }, normalStyles));
    ...
    static changeVerticesLocation(latlng, markerVertices) {
        ...
        Object.keys(markerVertices).forEach((key) => {
            ...
            const latLngs = L__default.LatLngUtil.cloneLatLngs(vertice.getLatLngs());
...
class LineTool extends AbstractTool {
    constructor(props) {
        ...
        this._polylineCreate = () => {
            if (!this.leafletMap)
                return;
            this.activetool = new L__default.Draw.Polyline(this.leafletMap, {
                shapeOptions: {
...
class PolygonTool extends AbstractTool {
    constructor(props) {
        ...
        this._polygonCreate = () => {
            if (!this.leafletMap)
                return;
            this.activetool = new L__default.Draw.Polygon(this.leafletMap, {
...
SearchTool.putMarkerOnMap = (featureGroup, latlng, popup, iconUrl, connectClick = false) => {
    ...
    const icon = new L__default.Icon(Object.assign(Object.assign({}, iconStarter), additionalOpts));
    const marker = new L__default.Marker.Touch(latlng, { icon });
    if (popup) {
...
SearchTool.fetchAreas = (countryCode, adminLevel, highQuality, color) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        (_c = (_b = gJSON === null || gJSON === void 0 ? void 0 : gJSON.features) === null || _b === void 0 ? void 0 : _b.filter((feat) => { var _b; return ((_b = feat === null || feat === void 0 ? void 0 : feat.geometry) === null || _b === void 0 ? void 0 : _b.type) === "Polygon"; })) === null || _c === void 0 ? void 0 : _c.forEach((feat) => {
            ...
            const latlngs = L__default.GeoJSON.coordsToLatLngs(coords, 1);
            const drawnCountry = new L__default.polygon(latlngs, Object.assign(Object.assign({}, opts), normalStyles));
 ...
 * @author Andrej Tlcina
 */
class DrawingLayerToolState extends LayerToolState {
    /**
    ...
    constructor(tool) {
        ...
        this.featureGroup = new L__default.FeatureGroup();
    ...
    deserializeGeoJSON(geojson) {
        ...
        if (geojson.type === "FeatureCollection" && geojson.features) {
            geojson.features
                ...
                let result;
                if (lType === "polygon") {
                    result = new L__default.polygon(latlng, opts);
                }
                else if (lType === "polyline") {
                    result = new L__default.polyline(latlng, opts);
                }
                    ...
                    const icon = new L__default.Icon(options);
                    result = new L__default.Marker.Touch(latlng, { icon });
                }
                if (result) {
    ...
    deserialize(config) {
        ...
        data.forEach((layer) => {
            ...
            if (layer.layerType === "marker") {
                const { latlngs } = layer;
                const latlng = L__default.latLng(latlngs.lat, latlngs.lng);
                ...
                const iconAnchor = layer.options.iconAnchor
                    ? {
                        iconAnchor: new L__default.Point(layer.options.iconAnchor.x, layer.options.iconAnchor.y),
                    }
                    : {};
                const iconSize = layer.options.iconSize
                    ? {
                        iconSize: new L__default.Point(layer.options.iconSize.x, layer.options.iconSize.y),
                    }
                    : {};
                const options = Object.assign(Object.assign(Object.assign({}, layer.options), iconAnchor), iconSize);
                const MyCustomMarker = L__default.Icon.extend({
                    options,
                });
                ...
                if (layer.layerType === "polyline" || layer.layerType === "vertice") {
                    _latlng = layer.latlngs[0].map((l) => L__default.latLng(l.lat, l.lng));
                    poly = new L__default.polyline(_latlng, layer.options);
                }
                if (layer.layerType === "polygon" || layer.layerType === "painted") {
                    _latlng = layer.latlngs[0].map((l) => L__default.latLng(l.lat, l.lng));
                    poly = new L__default.polygon(_latlng, layer.options);
                }
                layerToAdd = poly;
            }
            if (layer.popupContent) {
 ...
 * @author Andrej Tlcina
 */
class DrawingLayerToolDefaults extends LayerToolDefaults {
    /**
...
class DrawingMapFormInputFactory extends MapFormInputFactory {
    /**
...
class MarkerControlState extends AbstractControlState {
    constructor(props) {
        ...
        this.changeIconOpts = (iconOpt = {}) => {
            ...
            const markerIcon = new L__default.Icon(newIconOptions);
            if (marker)
...
class SearchControlState extends AbstractControlState {
    constructor(props) {
        ...
        this.onInputOptClick = (value) => {
            ...
            const latlng = L__default.latLng(0, 0);
 ...
 * @author Andrej Tlcina
 */
class DrawingLayerToolMapForm extends MapLayerToolForm {
    constructor(props) {
        super(props.tool);
...
const polyIntersect = (layer, state) => {
    ...
    if (!selectedLayer || !isLayerPoly(selectedLayer))
        return layer;
    const { layer: updatedLayer, result } = operateOnSelectedAndCurrectLayer(layer, (a, b) => turf.intersect(a, b), selectedLayer);
    if (result) {
        layer.remove();
    }
    return updatedLayer;
        ...
        if (diffFeature) {
            ...
            try {
                ...
                if (isJustPoly && coords.length !== 1) {
                    latlngs = L__default.GeoJSON.coordsToLatLngs(coords, 1);
                    const result = new L__default.polygon(latlngs, Object.assign({}, geoObject.options));
                    ...
                    // @ts-ignore
                    coords.forEach((coord) => {
                        latlngs = L__default.GeoJSON.coordsToLatLngs([coord], depth);
                        const result = new L__default.polygon(latlngs, Object.assign({}, geoObject.options));
...
L__default.Draw.Feature.include(L__default.Evented.prototype);
L__default.Draw.Feature.include(L__default.Draw.Feature.SnapMixin);
L__default.Draw.Feature.addInitHook(L__default.Draw.Feature.SnapMixin._snap_initialize);
/**
...
class DrawingLayerTool extends AbstractLayerTool {
    ...
    createLayerItems() {
        ...
        this.controlDrawingToolbar = L__default.control.drawingToolbar({
            tool: this,
            selectedTool: null,
        });
        if (this.isEnabled()) {
    ...
    applyEventListeners(layer) {
        layer
            .on("click", L__default.DomEvent.stopPropagation)
    ...
    highlightElement(el) {
        if (el === null || el === void 0 ? void 0 : el._icon) {
            L__default.DomUtil.addClass(el._icon, "highlight-marker");
        }
        else {
    ...
    normalizeElement(el) {
        if (el === null || el === void 0 ? void 0 : el._icon) {
            L__default.DomUtil.removeClass(el._icon, "highlight-marker");
        }
        else {
            if (el === null || el === void 0 ? void 0 : el.setStyle)
...
export { DrawingLayerTool, DrawingLayerToolDefaults, DrawingLayerToolMapForm, DrawingLayerToolState, DrawingLayerToolMapFormState as DrawingLayerToolTabState, GeovistoDrawingLayerTool };
