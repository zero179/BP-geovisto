import { Feature, LineString, MultiLineString, MultiPoint, MultiPolygon, Point, Polygon } from "@turf/turf";
...
export type LayerType = "marker" | "polyline" | "polygon" | "painted" | "vertice" | "erased" | "knife" | "search" | "geojson";
export interface LooseObject {
    [key: string]: any;
}
export type DrawnOptions = {
...
export type GeoFeature = Feature<Point | MultiPoint | LineString | MultiLineString | Polygon | MultiPolygon>;
export type Optional<T> = T | null;
export type Tool = TAbstractTool | TDeselectTool | TEditTool | TEraseTool | TFreehandSliceTool | TGeometricSliceTool | TJoinTool | TLineTool | TMarkerTool | TPaintTool | TPolygonTool | TRemoveTool | TSearchTool | TTopologyTool | TTransformTool;
